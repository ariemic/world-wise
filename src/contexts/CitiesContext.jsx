...
function CitiesProvider({ children }) {
  ...
  useEffect(function () {
    async function fetchCities() {
      try {
        ...
        dispatch({
          type: "rejected",
          payload: "There is a problem with loading cities data...",
        });
      }
    }
    fetchCities();
  ...
  // We can't use async logic in reducer because it only takes pure functions
  const getCity = useCallback(
    async function getCity(id) {
      ...
      try {
        ...
        dispatch({
          type: "rejected",
          payload: "There is a problem with loading a city data...",
        });
      }
    },
    [currentCity.id]
  ...
  async function createCity(newCity) {
    try {
      ...
      dispatch({
        type: "rejected",
        payload: "There is a problem while adding a city...",
      });
    }
  }
  ...
  async function deleteCity(id) {
    try {
      ...
      dispatch({
        type: "rejected",
        payload: "There is a problem while deleting city...",
      });
    }
  }
